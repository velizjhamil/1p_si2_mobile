...
class Producto {
 ...
 final dynamic dispSucursales = json['disponibilidad_sucursales'];
 ...
 : const [],
 disponibilidadSucursales: dispSucursales is List
 ? dispSucursales
 .whereType<Map<String, dynamic>>()
 .map(DisponibilidadSucursalDto.fromJson)
 .toList()
 : const [],
 );
 }
...
/// Disponibilidad física de stock por sucursal para la prenda.
class DisponibilidadSucursalDto {
 const DisponibilidadSucursalDto({
 ...
 factory DisponibilidadSucursalDto.fromJson(Map<String, dynamic> json) =>
 DisponibilidadSucursalDto(
 idSucursal: (json['id_sucursal'] as num?)?.toInt() ?? 0,
 nombreSucursal: json['nombre_sucursal'] as String? ?? 'Sucursal',
...
/// Color option as returned by /productos.
class ColorDto {
...
/// Fetches the product catalog for the client app.
class ProductosService {
 ...
 if (soloDisponibles) 'solo_disponibles': 'true',
 };
