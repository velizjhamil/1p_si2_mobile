...
/// Screen for the Virtual Fitting Room with AI Fashion Assistant.
///
...
/// 4. Directly Add to Cart or Reserve in Store.
...
class _ProbadorVirtualScreenState extends State<ProbadorVirtualScreen> {
 ...
 bool _mostrarFotoOriginal = false;
 ...
 sim.resultadoImagenUrl != _imageDataUrl) {
 if (sim.resultadoImagenUrl!.startsWith('data:image/')) {
 try {
 ...
 onPressed: _prendaSeleccionada != null && _pasoActual != _PasoProbador.simulando
 ? _ejecutarSimulacionIA
 : null,
 style: FilledButton.styleFrom(
 ...
 icon: _pasoActual == _PasoProbador.simulando
 ? const SizedBox(
 width: 18,
 height: 18,
 ...
 Colors.purple.shade50.withValues(alpha: 0.15),
 ],
 ),
 boxShadow: [
 BoxShadow(
 ...
 Flexible(
 child: Text(
 'Por favor espera, la IA está fusionando la prenda sobre tu silueta con alta precisión.',
 textAlign: TextAlign.center,
 style: TextStyle(
 fontSize: 12,
 fontWeight: FontWeight.w600,
 ...
 fit: StackFit.expand,
 children: [
 // Base User Photo or AI Composite Try-On Result
 _renderResultVisualizerWidget(sim),
 ...
 // Top Left Tag: AI Virtual Fitted
 Positioned(
 top: 14,
 left: 14,
 child: Container(
 ...
 Text(
 _mostrarFotoOriginal ? 'Foto Original' : 'Fusión Nano Banana Pro',
 style: const TextStyle(
 color: Colors.white,
 fontSize: 11,
 fontWeight: FontWeight.bold,
 ...
 // Top Right: Compare Mode Toggle Button
 Positioned(
 top: 14,
 right: 14,
 child: InkWell(
 onTap: () => setState(() => _mostrarFotoOriginal = !_mostrarFotoOriginal),
 borderRadius: BorderRadius.circular(20),
 child: Container(
 padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 5),
 decoration: BoxDecoration(
 ...
 children: [
 Icon(
 _mostrarFotoOriginal ? Icons.auto_awesome : Icons.compare_rounded,
 color: Colors.white,
 size: 13,
 ),
 const SizedBox(width: 5),
 Text(
 _mostrarFotoOriginal ? 'Ver Prenda IA' : 'Comparar Original',
 style: const TextStyle(
 color: Colors.white,
 fontSize: 11,
 fontWeight: FontWeight.bold,
 ...
 child: Icon(Icons.compare_arrows_rounded, color: Colors.grey, size: 18),
 ),
 Expanded(
 child: _buildMetricBox(
 label: 'Sugerida IA',
 ...
 // Direct Action Buttons: Cart & Reservation
 Row(
 children: [
 Expanded(
 child: OutlinedButton.icon(
